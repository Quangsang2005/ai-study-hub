...
import { chatThreads } from '../../mocks/chatMock';
...
function AiTutorPage() {
  ...
  return (
    <div style={{ display: 'flex', margin: '-14px -28px -32px', height: 'calc(100vh - 70px)', background: 'linear-gradient(135deg, #ffffff 0%, #fbfaff 62%, #f7f4ff 100%)' }}>
      <ChatSidebar threads={chatThreads} variant="newChat" showCourseFolders={false} />
